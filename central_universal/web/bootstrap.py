...
from central_universal.evidence.rule_versions import V0_2_2_VERSION, build_v0_2_2_rule_version
...
DEFAULT_RULE_VERSION = V0_2_2_VERSION
...
def ensure_bootstrapped(db_path) -> None:
    ...
    try:
        ...
        if rule_version is None:
            rule_version = build_v0_2_2_rule_version()
