...
from central_universal.domain.entities import Competency, Learner, LearningDomain
from central_universal.domain.ids import new_id
from central_universal.domain.enums import RoutingDecision
from central_universal.persistence.repositories import Repositories


def test_decision_service_records_events_with_justification(repos: Repositories, make_rule_version):
